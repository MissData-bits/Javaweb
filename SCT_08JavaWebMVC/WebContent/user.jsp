...
<p>
    <h1>教师信息列表</h1>
<h4><a href="/stu54/userAddTeacher.jsp">添加教师</a></h4>
<table width="400px" cellspacing="0px" border="1px">
    ...
    for(Teacher teacher : teachers){%>
        <tr>
            ...
            <td>
                <form action="/stu54/userUpdateTeacher.jsp" method="get">
                    <input type="hidden" name="update" value="<%=teacher.getTid()%>">
                    <input type="submit" value="修改">
                </form>
            </td>
            <td>
                <form action="/stu54/userDeleteTeacher.jsp" method="get">
...
<p>
<h1>学生信息列表</h1>
<h4><a href="/stu54/userAddStudent.jsp">添加学生</a></h4>
<table width="400px" cellspacing="0px" border="1px">
    <tr>
        <td>学号</td>
        <td>姓名</td>
    ...
    <tr>
        ...
        <td>
            <form action="/stu54/userUpdateStudent.jsp" method="get">
                <input type="hidden" name="update" value="<%=student.getSid()%>">
                <input type="submit" value="修改">
            </form>
        </td>
        <td>
            <form action="/stu54/userDeleteStudent.jsp" method="get">
...
<p>
<h1>课程信息列表</h1>
<h4><a href="/stu54/userAddCourse.jsp">添加课程</a></h4>
<table width="400px" cellspacing="0px" border="1px">
    <tr>
        <td>编号</td>
        <td>课程名</td>
    ...
    <tr>
        ...
        <td>
            <form action="/stu54/userUpdateCourse.jsp" method="get">
                <input type="hidden" name="update" value="<%=course.getCid()%>">
                <input type="submit" value="修改">
            </form>
        </td>
        <td>
            <form action="/stu54/userDeleteCourse.jsp" method="get">
